...
const envBase = (typeof window !== 'undefined' && window.__API_BASE_URL__) || (typeof process !== 'undefined' && process.env && process.env.VUE_APP_API_BASE_URL) || ''
const isDev = typeof window !== 'undefined' && /localhost|127\.0\.0\.1/.test(window.location.host)
const baseURL = envBase !== '' ? envBase : (isDev ? '/api' : '')
